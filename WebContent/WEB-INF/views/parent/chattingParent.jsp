...
.media.conversation:hover {
    background: rgb(243, 190, 78) none repeat scroll 0 0;color:#fff !important;
}
.media-body small.col-sm-12 {
    font-size: 14px;
}
.media.conversation:hover .media-heading a{color:#fff;}
.media-body h5.media-heading {margin:0;}
...
<img src="resources/dashboard/Images/chat.jpg">
				...
				<div id="typing_on" style="display:none;"><img src="resources/dashboard/Images/typing.gif"></div>
					...
					<a href="javascript:void(0);" onclick="sendMessage();" id="send-msg"
