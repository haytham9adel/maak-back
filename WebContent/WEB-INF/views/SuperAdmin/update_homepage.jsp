...
<div class="form-group pull-right">
       <div class="col-sm-9">
       <a href="admin/manage_slider">
       <input type="button" value="Manage Slider" class="btn btn-primary btn-submit">
       </a>
       </div>
</div>  
...
<div class="form-group">
     <label class="col-sm-3 control-label"><b>Heading2:</b> </label>
       <div class="col-sm-9">
        <input type="text" name="heading2" value="${content.heading2}" id="heading2" placeholder="WHAT WE DO" class="form-control">
       </div>
</div>
<div class="form-group">
     <label class="col-sm-3 control-label"><b>Description2:</b> </label>
       <div class="col-sm-9">
...
<div class="form-group">
     <label class="col-sm-3 control-label"><b>Heading3:</b> </label>
       <div class="col-sm-9">
        <input type="text" name="heading3" value="${content.heading3}" id="heading3" placeholder="MISSION" class="form-control">
       </div>
</div>
<div class="form-group">
     <label class="col-sm-3 control-label"><b>Description3:</b> </label>
       <div class="col-sm-9">
...
<div class="form-group">
     <label class="col-sm-3 control-label"><b>Heading4:</b> </label>
       <div class="col-sm-9">
        <input type="text" name="heading4" value="${content.heading4}" id="heading3" placeholder="" class="form-control">
       </div>
</div>
<div class="form-group">
     <label class="col-sm-3 control-label"><b>Description4:</b> </label>
       <div class="col-sm-9">
