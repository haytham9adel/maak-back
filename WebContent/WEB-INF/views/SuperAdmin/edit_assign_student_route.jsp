...
<div class="col-md-9 col-sm-9 col-xs-12 m-side">
             ...
             <span class="error">${error}</span>
                <form class="form-horizontal" id="student" method="post">
                     ...
                     <label class="col-sm-3 control-label">Assign Route to Student:</label>
                       <div class="col-sm-9">
                       <select class="form-control" id="route_id" name="route_id" onchange=" return getStudent(this.value);" >
                   ...
                   <div class="form-group">
                     <label class="col-sm-3 control-label">Student :</label>
                       <div class="col-sm-9">
                         <select class="form-control" id="student_id" name="student_id"  onchange=" return getAddress(this.value);" >
  ...
  <script>
  function getStudent(route_id) {
	  
  	var route_id=route_id;
  	  $.ajax({
          url : 'studentByRoute.html',
          type:'post',
  ...
  function getAddress(student_id) {
	  
	  	var student_id=student_id;
	  	  $.ajax({
	          url :'addressByStudent.html',
	          type:'post',
