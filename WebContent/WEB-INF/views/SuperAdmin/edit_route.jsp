...
<div class="col-md-9 col-sm-9 col-xs-12 m-side">
 ...
 <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyA7QTJeimvMfcLMul6ZsMRZA1qOfjsyHtc&sensor=false"></script>
  ...
  $(document).ready(function(){
		...
		$('#cancel').on('click', function(e) {
			...
			swal({
				...
				if (isConfirm)
					window.location = "admin/allRoute";
			});
		})	 
  });
