                ...
                <%-- 	 <div class="form-group">
                     ...
                     <label class="col-sm-3 control-label">Department:</label>
                       ...
                       <select class="form-control" id="dept_id" name="dept_id" >
                         ...
                         <c:if test="${!empty departments}">
                         	...
                         	<option  value=<c:out value="${depart.depart_id}"/>><c:out value="${depart.depart_name}"/></option>
                         	</c:forEach>
                         </c:if>
                         </select>
                     </div>
                       ...
                       <div class="col-sm-9">
                         ...
                         <input type="text" name="staff_name" value="${staff.staff_name}" id="staff_name" class="form-control">
                          <input type="hidden"  name="image_path" id="image_path" value="" class="form-control">
                           <input type="hidden"  name="school_id" id="school_id" value="<%= session.getAttribute("new_school_id") %>" class="form-control">
                        </div>
                   </div>
                     <div class="form-group">
                   ...
                   <div class="form-group">
                     <label class="col-sm-3 control-label">Email :</label>
                       <div class="col-sm-9">
                        <input type="email" name="staff_email" value="${staff.staff_email}" id="staff_email" class="form-control">
                       </div>
                   </div>
