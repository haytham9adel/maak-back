...
<link href="resources/dashboard/css/imgareaselect-default.css" rel="stylesheet" media="screen">
<link rel="stylesheet" href="resources/dashboard/css/jquery.awesome-cropper.css">
<script src="resources/dashboard/js/jquery.imgareaselect.js"></script> 
<script src="resources/dashboard/js/jquery.awesome-cropper.js"></script> 
<script>
...
<div class="col-md-6 col-sm-6 col-xs-12 m-side">
	...
	<div class="new-student-form">
		...
		<form class="form-horizontal" id="student" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
					<a href="admin/addParent" class="pull-right"><button
							type="button" class="btn btn-primary btn-light">Add
							Parent</button></a>
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">Profile Pictsdfsdfsure :</label>
				<div class="col-sm-9">
					<form role="form">
		...
		google.maps.event
				.addListener(
						...
						function(e) {
							...
							if (alphaIdx > parseInt(longiArr.length)) {
								return;
							}
